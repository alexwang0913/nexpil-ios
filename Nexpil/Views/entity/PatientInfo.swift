...
struct PatientInfo {
    ...
    func saveUserInfo()
    {
        ...
        defaults.set(self.snooze, forKey: "snooze")
    }
    static func DeleteUserInfo()
    {
        ...
        defaults.set(nil,forKey:"active")
        defaults.set(nil,forKey:"age")
        defaults.set(nil,forKey:"application_location")
        defaults.set(nil,forKey:"birthday")
        defaults.set(nil,forKey:"city")
        defaults.set(nil,forKey:"diagnosis_date")
        defaults.set(nil,forKey:"email")
        defaults.set(nil,forKey:"first_name")
        defaults.set(nil,forKey:"last_name")
        defaults.set(nil,forKey:"language")
        defaults.set(nil,forKey:"location")
        defaults.set(nil,forKey:"phone_number")
        defaults.set(nil,forKey:"sex")
        defaults.set(nil,forKey:"user_name")
        defaults.set(nil,forKey:"usertype")
        defaults.set(nil,forKey:"zipcode")
        defaults.set(nil,forKey:"state")
        defaults.set(nil,forKey:"street")
        defaults.set(nil,forKey:"userimage")
        defaults.set(nil,forKey:"usercode")
        defaults.set(nil, forKey: "createdAt")
        defaults.set(nil, forKey: "address")
        defaults.set(nil, forKey: "snooze")
    }
