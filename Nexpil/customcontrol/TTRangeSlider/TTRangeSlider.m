...
- (void)initialiseControl {
    ...
    UIImage *image = [UIImage imageNamed:@"GradientLayer"];
    self.sliderLineBetweenHandles.contents = (__bridge id _Nullable)(image.CGImage);
    ...
    UIColor *leftColor = [UIColor colorWithRed:57/255 green:211/255 blue:227/255 alpha:1.0];
    self.leftHandle.backgroundColor = leftColor.CGColor;
...
- (void)updateHandlePositions {
    ...
    self.sliderLineBetweenHandles.frame = CGRectMake(self.leftHandle.position.x, self.sliderLine.frame.origin.y - 2, self.rightHandle.position.x-self.leftHandle.position.x, self.lineHeight + 4);
}
