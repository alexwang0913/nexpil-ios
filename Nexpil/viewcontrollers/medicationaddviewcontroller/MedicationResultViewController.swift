    ...
    @objc func gotoNext1(sender : UITapGestureRecognizer) {
        ...
        */
        ...
        //{
            ...
            var min1 = Int(min)!/5
            min1 = min1 * 5
        let data = MyMedication.init(prescribe: "", directions: frequency.text!, dose: "", image: "", quantity: 0, type: "", taketime: "", medicationname: medication.text!, filedDate: DataUtils.getMedicationDate()!, warning: "", frequency: "", strength: strength.text!, pharmacy: "", patientname: "", lefttablet: DataUtils.getLeftTablet()!, prescription: DataUtils.getPrescription(), createat: currentDate + " \(hour):\(min1)", endat: "", id:Int(DataUtils.getDrugId()!)!, amount: "", asneeded: 0)
            datas.append(data)
