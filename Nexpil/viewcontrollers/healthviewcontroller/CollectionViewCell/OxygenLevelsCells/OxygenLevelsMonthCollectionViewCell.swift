//
//  OxygenLevelsMonthCollectionViewCell.swift
//  Nexpil
//
...
import UIKit
import Charts
class OxygenLevelsMonthCollectionViewCell: UICollectionViewCell {
    weak var delegate:OxygenLevelsMonthCollectionViewCellDelegate?
...
protocol OxygenLevelsMonthCollectionViewCellDelegate: class {
