//
//  StepsDayCollectionViewCell.swift
//  Nexpil
//
...
import UIKit
import Charts
protocol StepsDayCollectionViewCellDelegate: class {
...
class StepsDayCollectionViewCell: UICollectionViewCell {
weak var delegate:StepsDayCollectionViewCellDelegate?
    ...
    @IBOutlet weak var bgValue: UIView!{
        didSet{
            bgValue.viewShadow2()
        }
    }
...
//        lblValue2.font = UIFont.init(name: "Montserrat", size: 15)
        ...
        lblTitle.text = dateFormatterPrint.string(from: GlobalManager.GetToday())
    }
    ...
    func initChartView() {
        ...
        self.setChartView(xVal: [0], yVal: [0])
    }
...
//        }
    ...
    func getCalories(dis: Double) {
        let distancemile = CGFloat(dis * 0.0006213)
        let caloiespermile = 3.7103 + 0.2678 * 60 + CGFloat(0.0359 * (60 * 60 * 0.0006213) * 2) * 60
