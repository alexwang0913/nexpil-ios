//
//  BloodGlucoseWeekCollectionView.swift
//  Nexpil
//
...
import UIKit
import Charts
class BloodGlucoseWeekCollectionView: UICollectionViewCell {
    ...
    var yVal1 = NSArray()
    var yVal2 = NSArray()
    weak var delegate:BloodGlucoseWeekCollectionViewCellDelegate?
...
protocol BloodGlucoseWeekCollectionViewCellDelegate: class {
