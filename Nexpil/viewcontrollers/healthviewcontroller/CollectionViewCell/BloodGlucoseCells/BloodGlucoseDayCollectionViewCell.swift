//
//  BloodGlucoseDayCollectionViewCell.swift
//  Nexpil
//
//  Created by ankit vaish on 29/05/19.
//  Copyright © 2019 Admin. All rights reserved.
//

import UIKit
import Charts
protocol BloodGlucoseDayCollectionViewCellDelegate: class {
...
class BloodGlucoseDayCollectionViewCell: UICollectionViewCell {

    weak var delegate:BloodGlucoseDayCollectionViewCellDelegate?
    ...
    func initChartView() {
        ...
        self.setChartView(xVal: [8, 12, 16], yVal1: [0, 0, 0], yVal2: [0, 0, 0])
    }
    ...
    @IBAction func tapBtnValue(_ sender: Any) {
        ...
        self.delegate?.didTapButtonBloodGlucoseDayCollectionViewCell(index: tag,
                                                                sendDic: sendDic)
    }
