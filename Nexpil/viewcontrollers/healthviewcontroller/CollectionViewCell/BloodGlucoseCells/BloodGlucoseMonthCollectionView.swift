//
//  BloodGlucoseMonthCollectionView.swift
//  Nexpil
//
...
import UIKit
import Charts
class BloodGlucoseMonthCollectionView: UICollectionViewCell {
    weak var delegate:BloodGlucoseMonthCollectionViewCellDelegate?
...
protocol BloodGlucoseMonthCollectionViewCellDelegate: class {
