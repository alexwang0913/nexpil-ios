//
//  BloodPressureMonthCollectionViewCell.swift
//  Nexpil
//
...
import UIKit
import Charts
class BloodPressureMonthCollectionViewCell: UICollectionViewCell {
 weak var delegate:BloodPressureMonthCollectionViewCellDelegate?
...
protocol BloodPressureMonthCollectionViewCellDelegate: class {
