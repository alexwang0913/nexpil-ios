//
//  BloodPressureDayCollectionViewCell.swift
//  Nexpil
//
...
protocol BloodPressureDayCollectionViewCellDelegate: class {
...
class BloodPressureDayCollectionViewCell: UICollectionViewCell {
    weak var delegate:BloodPressureDayCollectionViewCellDelegate?
    ...
    func initChartView() {
        ...
        let yVal1 = NSArray.init(array: [0, 0, 0])
        let yVal2 = NSArray.init(array: [0, 0, 0])
