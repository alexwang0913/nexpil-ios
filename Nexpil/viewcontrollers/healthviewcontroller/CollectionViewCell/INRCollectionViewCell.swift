...
import UIKit
import Charts
class INRCollectionViewCell: UICollectionViewCell {
    ...
    weak var delegate:INRCollectionViewCellDelegate?
...
protocol INRCollectionViewCellDelegate: class {
