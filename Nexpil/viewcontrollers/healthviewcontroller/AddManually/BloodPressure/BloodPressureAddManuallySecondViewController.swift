//
//  BloodPressureAddManuallySecondViewController.swift
//  Nexpil
//
...
class BloodPressureAddManuallySecondViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        measurementLabel.text = "\(measurement) mmHg"
    ...
    private func selectButtonStyle(_ button: UIButton) {
        button.backgroundColor = NPColorScheme.purple.color
        button.layer.borderWidth = 1
        button.layer.borderColor = NPColorScheme.purple.color.cgColor
    ...
    @IBAction func nextButtonClick(_ sender: Any) {
        let viewController = UIStoryboard(name: "Health", bundle: nil).instantiateViewController(withIdentifier: "BloodPressureAddManuallyThirdViewController") as! BloodPressureAddManuallyThirdViewController
