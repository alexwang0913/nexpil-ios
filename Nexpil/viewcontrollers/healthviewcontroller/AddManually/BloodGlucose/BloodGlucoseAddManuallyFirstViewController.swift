...
protocol AddManuallyViewControllerDelegate {
    func dismissFirstStep()
}

class BloodGlucoseAddManuallyFirstViewController: UIViewController, AddManuallyViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        currentCircle.layer.borderColor = #colorLiteral(red: 0.2235294118, green: 0.4941176471, blue: 0.8901960784, alpha: 1)
    ...
    @IBAction func nextButtonClick(_ sender: Any) {
        let viewController = UIStoryboard(name: "Health", bundle: nil).instantiateViewController(withIdentifier: "BloodGlucoseAddManuallySecondViewController") as! BloodGlucoseAddManuallySecondViewController
        
        viewController.measurement = measurementTextField.text ?? ""
        viewController.firstStepDelegate = self
