//
//  OxygenLevelAddManuallyThirdViewController.swift
//  Nexpil
//
...
class OxygenLevelAddManuallyThirdViewController: UIViewController {
    ...
    @IBAction func doneButtonClick(_ sender: Any) {
        let viewController = UIStoryboard(name: "Health", bundle: nil).instantiateViewController(withIdentifier: "OxygenLevelAddManuallyFinalViewController") as! OxygenLevelAddManuallyFinalViewController
...
extension OxygenLevelAddManuallyThirdViewController: CalendarViewDataSource {
    func startDate() -> Date {
        return Date()
    }
...
extension OxygenLevelAddManuallyThirdViewController: CalendarViewDelegate {
