...
class SubDetails113ViewController: UIViewController{
...
extension SubDetails113ViewController:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: view.frame.width, height: 810)
    }
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let dicList = arrayList[indexPath.row] as! NSDictionary
        collectionView.register(UINib(nibName: "LipidPanelTotalCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "LipidPanelTotalCollectionViewCell")
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "LipidPanelTotalCollectionViewCell", for: indexPath) as! LipidPanelTotalCollectionViewCell
...
extension SubDetails113ViewController:LipidPanelTotalCollectionViewCellDelegate{
