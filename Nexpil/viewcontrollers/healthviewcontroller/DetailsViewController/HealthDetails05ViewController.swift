...
class HealthDetails05ViewController: UIViewController, CAPSPageMenuDelegate, SubDetails050ViewControllerDelegate {
    ...
    */
    ...
    func didTapButtonAddWithSubDetails050ViewController() {
        let viewController = (self.storyboard?.instantiateViewController(withIdentifier: "WeightAddFirstViewController") as? WeightAddFirstViewController)!
