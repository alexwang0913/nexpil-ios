...
class SubDetails111ViewController: UIViewController {
...
extension SubDetails111ViewController:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        collectionView.register(UINib(nibName: "LipidPanelLDLCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "LipidPanelLDLCollectionViewCell")
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "LipidPanelLDLCollectionViewCell", for: indexPath) as! LipidPanelLDLCollectionViewCell
...
extension SubDetails111ViewController:LipidPanelLDLCollectionViewCellDelegate{
