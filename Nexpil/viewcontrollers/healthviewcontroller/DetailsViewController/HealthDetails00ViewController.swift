    ...
    */
    ...
    func initContentViewControllers() {
        ...
        let parameters = [
            ...
            CAPSPageMenuOptionMenuItemWidth: self.view.frame.width,
            ...
            CAPSPageMenuOptionBottomMenuHairlineColor:UIColor.gray,
            ] as NSDictionary
...
//        self.loadScanBloodGlucoseViewController(index: 3)
    ...
    func loadScanBloodGlucoseViewController() {
        ...
        self.present(scanBloodGlucoseViewController, animated: false, completion: nil)
    }
    ...
    func loadAddManuallyBloodGlucoseViewController(index: NSInteger, sendDic: NSDictionary) {
       ...
       // self.present(addManuallyBloodGlucoseViewController, animated: false, completion: nil)
        UIApplication.shared.keyWindow?.addSubview((addManuallyBloodGlucoseViewController.view)!)
    }
