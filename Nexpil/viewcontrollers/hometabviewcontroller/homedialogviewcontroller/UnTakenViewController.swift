...
class UnTakenViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        let historys = DBManager.getObject().getMedicationInfosById1(id:medicationId)
    ...
    @IBAction func gotoDone(_ sender: Any) {
        ...
        //{
            ...
            if startValue < value && value < endValue
            {
                ...
                //time set
                DBManager.getObject().updateMedicationTakeTime(id: takeMedication!.id, eatTime: "", eatText: "", taketime: updateTime)
                updateTakeTime()
            }
            else{
